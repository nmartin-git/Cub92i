...
/*   Updated: 2025/07/02 18:33:19 by igrousso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "crosshair.h"

void	vertical_crosshair(t_pos pixel, t_image *crosshair, int color)
{
	int	i;
	int	j;
	int	k;
...
void	horizontal_crosshair(t_pos pixel, t_image *crosshair, int color)
{
	int	i;
	int	j;
	int	k;
...
int	init_crosshair(t_data *data)
{
	...
	if (!crosshair)
		return (1);
    color = CYAN;
	vertical_crosshair(pixel, crosshair, color);
	horizontal_crosshair(pixel, crosshair, color);
