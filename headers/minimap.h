...
/*   Updated: 2025/07/13 16:43:54 by igrousso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_raycasting(t_minimap *minimap, float fov, int ray_nbr,
			t_data *data);

/*---rays.c---*/
int		is_wall(t_minimap *minimap, t_data *data, t_pos *pos);
void	vertical_wall(t_minimap *minimap, t_data *data, t_pos *pos,
			float angle);
void	horizontal_wall(t_minimap *minimap, t_data *data, t_pos *pos,
			float angle);
